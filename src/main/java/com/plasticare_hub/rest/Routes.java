package com.plasticare_hub.rest;


import org.reflections.Reflections;

import com.plasticare_hub.rest_handlers.user_access_mgmt.auth.ApiKeyAuthHandler;
import com.plasticare_hub.rest_handlers.user_access_mgmt.auth.Rbac;
...
public class Routes
{
    public static RoutingHandler routesRegister()
    {
        ...
        Reflections reflections = new Reflections("com.platicare_hub.rest_handlers");
